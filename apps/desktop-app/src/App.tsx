    ...
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div className="card">
          ...
          <button className="btn-primary" onClick={() => addLog('Connecting to OBS...')}>Connect OBS</button>
        </div>

        <div className="card">
          <h2>Game RCON</h2>
          <p><span className="status-dot status-red"></span>Disconnected</p>
          <button className="btn-primary" onClick={() => addLog('Connecting to Game...')}>Connect Game</button>
        </div>
      </div>
